...
spec = describe "HaskellWorks.Data.Succinct.RankSelect.InternalSpec" $ do
  describe "For [Bool]" $ do
    ...
    it "select1 11011010 00 over [0..5]" $
      let bs = fromJust $ bitRead "11011010 00" :: [Bool] in
  ...
  describe "For Word64" $ do
    ...
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: Word64
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
  ...
  describe "For [Word8]" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: [Word8]
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For [Word16]" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: [Word16]
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For [Word32]" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: [Word32]
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For (DV.Vector Word8)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DV.Vector Word8
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For (DV.Vector Word16)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DV.Vector Word16
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For (DV.Vector Word32)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DV.Vector Word32
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For (DV.Vector Word64)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DV.Vector Word64
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
  ...
  describe "For (DVS.Vector Word16)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DVS.Vector Word16
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
      let bs = fromJust $ bitRead "11011010 00000000" :: DVS.Vector Word16
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select 01000000 00000100 over [0..2]" $ do
      let bs = fromJust $ bitRead "01000000 00000100" :: DVS.Vector Word16
      fmap (select1 bs) [0..2] `shouldBe` [0, 2, 14]
    it "select 10000010 00000000 00100000 00010000 over [0..4]" $ do
      let bs = fromJust $ bitRead "10000010 00000000 00100000 00010000" :: DVS.Vector Word16
      fmap (select1 bs) [0..4] `shouldBe` [0, 1, 7, 19, 28]
  describe "For (DVS.Vector Word32)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DVS.Vector Word32
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
      let bs = fromJust $ bitRead "11011010 00000000" :: DVS.Vector Word32
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select 01000000 00000100 over [0..2]" $ do
      let bs = fromJust $ bitRead "01000000 00000100" :: DVS.Vector Word32
      fmap (select1 bs) [0..2] `shouldBe` [0, 2, 14]
    it "select 10000010 00000000 00100000 00010000 over [0..4]" $ do
      let bs = fromJust $ bitRead "10000010 00000000 00100000 00010000" :: DVS.Vector Word32
      fmap (select1 bs) [0..4] `shouldBe` [0, 1, 7, 19, 28]
  describe "For (DVS.Vector Word64)" $ do
    ...
    it "select1 11000001 10000000 01000000 over [0..5] should be 023568" $ do
      ...
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 8, 9, 18]
    it "select1 1101101000 over [0..5]" $ do
      let bs = fromJust $ bitRead "1101101000" :: DVS.Vector Word64
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select1 11011010 00000000 over [0..5]" $ do
      let bs = fromJust $ bitRead "11011010 00000000" :: DVS.Vector Word64
      fmap (select1 bs) [0..5] `shouldBe` [0, 1, 2, 4, 5, 7]
    it "select 01000000 00000100 over [0..2]" $ do
      let bs = fromJust $ bitRead "01000000 00000100" :: DVS.Vector Word64
      fmap (select1 bs) [0..2] `shouldBe` [0, 2, 14]
    it "select 10000010 00000000 00100000 00010000 over [0..4]" $ do
      let bs = fromJust $ bitRead "10000010 00000000 00100000 00010000" :: DVS.Vector Word64
      fmap (select1 bs) [0..4] `shouldBe` [0, 1, 7, 19, 28]
